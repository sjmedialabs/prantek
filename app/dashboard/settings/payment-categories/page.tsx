  ...
  const filteredCategories = categories
    ...
    .filter((cat) => {
      if (statusFilter === "active") return cat.
        isEnabled
      if (statusFilter === "inactive") return !cat.
        isEnabled
      return true
    })
    ...
    <div className="flex justify-between items-center mt-4">
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-[500px]">
          <DialogHeader>
            <DialogTitle>{editingCategory ? "Edit Ledger" : "Add Ledger"}</DialogTitle>
            <DialogDescription>
              {editingCategory ? "Update the Ledger name" : "Create a new payment Ledger"}
            </DialogDescription>
          </DialogHeader>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleSave}>
              ...
              {editingCategory ? "Update Ledger" : "Add Ledger"}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
