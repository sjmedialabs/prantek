...
export default function BackupPage() {
  ...
  const EXCLUDED_FIELDS = ["_id", "createdAt", "updatedAt", "updateAt", "id", "Id", "transaction_id", "clientId", "vendorId", "employeeId", "userId", "companyId", "tenantId", "recipientId", "designation", "transactionId", "lastLogin", "employee", "screenshotUrl", "screenshotFile", "billFile", "billUpload", "photo", "adharUpload", "educationCertificates", "experienceCertificates", "userCount", "isActive",]
      ...
      const formattedData = data.map((row) => {
        ...
        Object.keys(row).forEach((key) => {
          ...
          // 🔥 Convert objects AFTER date check
            ...
            else if (key.toLowerCase().includes("bank_account")) {
              value = `${value.accountName || ""} - ${value.accountNumber || ""} (IFSC: ${value.ifscCode || ""})`
            }
